...
def get_reviews(data, token_api):
    if data['source'] == 'youtube':
        url = 'http://ec2-52-206-110-32.compute-1.amazonaws.com/api/v1/youtube/videos/'
    elif data['source'] == 'facebook':
        url = 'http://ec2-52-206-110-32.compute-1.amazonaws.com/api/v1/facebook/posts/'
    elif data['source'] == 'instagram':
        url = 'http://ec2-52-206-110-32.compute-1.amazonaws.com/api/v1/instagram/posts/'
    else:
