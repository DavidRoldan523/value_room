...
def get_reviews(data, token_api):
    if data['source'] == 'youtube':
        url = 'http://ec2-18-234-178-42.compute-1.amazonaws.com:8001/api/v1/youtube/videos/'
    elif data['source'] == 'facebook':
        url = 'http://ec2-18-234-178-42.compute-1.amazonaws.com:8001/api/v1/facebook/posts/'
    elif data['source'] == 'instagram':
        url = 'http://ec2-18-234-178-42.compute-1.amazonaws.com:8001/api/v1/instagram/posts/'
    else:
